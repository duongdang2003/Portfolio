...
export default function ProjectCard(props) {
  ...
  return (
    <div>
      <div class="block rounded-lg bg-[rgb(44_47_62)] shadow-xl h-full shadow-lg">
        <div
        ...
        <div class="p-5">
          <div class="flex flex-col">
            <div className="text-xs text-gray-400">{props.publishDate}</div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <div className="flex items-center">
                <ExtensionIcon sx={{ color: grey[500] }} />
            ...
            <div>
              <div className="flex items-center">
                <SportsEsportsIcon sx={{ color: grey[500] }} />
